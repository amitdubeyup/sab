...
export class ConfirmationComponent implements OnInit {
  ...
  getRemitterCommission(): void {
    if (this.commonService.userPram.userId && this.commonService.userPram.memberId && this.commonService.userPram.dmtTemplate) {
      ...
      this.commonService.getAuth('transact/getcommission?remitterId=' + this.remitterDetails.RemitterId + '&memberId=' + this.commonService.userPram.memberId + '&templateId=' + this.commonService.userPram.dmtTemplate + '&apId=' + this.walletId + '&docType=DMT&pmode=' + this.beneficiaryDetails.paymentMode)
        .subscribe(
          (res: any) => {
    ...
    if (this.totalFareFinal < walletBalance) {
      if (this.mPin === savedPin) {
        ...
        const passingData = {
          ...
          docType: this.beneficiaryDetails.paymentMode,
