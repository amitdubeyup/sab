...
export class BeneficiaryComponent implements OnInit {
  ...
  ngOnInit(): any {
    ...
    if (this.paymentMode == 'true' || this.paymentMode == 'false') {
      ...
      this.router.navigate(['/rt/merchant-transfer']);
    }
  ...
  addRemitter(addType: any): any {
    ...
    if (addType === 'add') {
      this.router.navigate(['/rt/merchant-transfer/beneficiary/addbene'], { queryParams: { data: jsonData } });
    }
    else {
      this.router.navigate(['/rt/merchant-transfer/beneficiary/importbene'], { queryParams: { data: jsonData } });
    }
  }
  ...
  navigateToNextPage(): any {
    ...
    this.router.navigate(['/rt/merchant-transfer/beneficiary/confirmation'], { queryParams: { data: jsonData } });
  }
