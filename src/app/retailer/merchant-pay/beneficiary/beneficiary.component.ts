...
export class BeneficiaryComponent implements OnInit {
  ...
  ngOnInit(): any {
    ...
    if (this.paymentMode == 'true' || this.paymentMode == 'false') {
      ...
      this.router.navigate(['/merchant/merchant-transfer']);
    }
  ...
  addRemitter(addType: any): any {
    ...
    if (addType === 'add') {
      this.router.navigate(['/merchant/merchant-transfer/beneficiary/addbene'], { queryParams: { data: jsonData } });
    }
    else {
      this.router.navigate(['/merchant/merchant-transfer/beneficiary/importbene'], { queryParams: { data: jsonData } });
    }
  }
  ...
  navigateToNextPage(): any {
    ...
    this.router.navigate(['/merchant/merchant-transfer/beneficiary/confirmation'], { queryParams: { data: jsonData } });
  }
