...
@Component({
  selector: 'app-travel-service-manager',
  templateUrl: './travel-service-manager.component.html',
  styleUrls: ['./travel-service-manager.component.css']
})
export class TravelServiceManagerComponent implements OnInit {
  ...
  GetApiMember(): any {
    if (this.commonService.userPram.userId && this.commonService.userPram.rmn) {
      this.commonService.getAuth('servicemanager/get-api-service?mid=&docType=TRVL')
        .subscribe(
          (res: any) => {
            if (res.isSuccess) {
  ...
  GetMemberType(): any {
    if (this.commonService.userPram.userId && this.commonService.userPram.rmn) {
      this.commonService.getAuth('servicemanager/get-service-manager?mid=&docType=TRVL')
        .subscribe(
          (res: any) => {
            console.log(res);
            if (res.isSuccess) {
