...
@Component({
  selector: 'app-aeps-service-manager',
  templateUrl: './aeps-service-manager.component.html',
  styleUrls: ['./aeps-service-manager.component.css']
})
export class AepsServiceManagerComponent implements OnInit {
  mbType: any = {};
  userList: any;
  respData: any;
  walletList: any;
  ...
  GetApiMember(): any {
    ...
    if (this.commonService.userPram.userId && this.commonService.userPram.rmn) {
      this.commonService.getAuth('servicemanager/get-api-service?mid=&docType=AEPS')
        .subscribe(
          (res: any) => {
            if (res.isSuccess) {
  ...
  GetMemberType(): any {
    if (this.commonService.userPram.userId && this.commonService.userPram.rmn) {
      this.commonService.getAuth('servicemanager/get-service-manager?mid=&docType=AEPS')
        .subscribe(
          (res: any) => {
            if (res.isSuccess) {
