...
@Component({
  selector: 'app-manage-fund-report',
  templateUrl: './manage-fund-report.component.html',
  styleUrls: ['./manage-fund-report.component.css']
})
export class ManageFundReportComponent implements OnInit {
  respData: any;
  fromDt: any = new Date();
  toDt: any = new Date();
  ...
  handleChange(e: any): any {
    ...
    if (this.activeTab === 0) {
      this.getRetailerCommission('BAL_CR');
    }
    else
    {
      ...
      Swal.fire({
        ...
        preConfirm: (login) => {
          if (savedPin === login) {
            ...
            Swal.showValidationMessage('Please Enter Valid MPIN');
          }
        },
