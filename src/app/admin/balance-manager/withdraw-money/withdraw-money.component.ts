...
export class WithdrawMoneyComponent implements OnInit {
  ...
  {
    this.commonService.getAuth('distributor/getdistributorbal?memberId=' + this.coutletid + '&dimemberid=' + this.commonService.userPram.memberId + '&txnNo=' + this.txnNo + '&fromDt=' + fromDt + '&toDt=' + toDt + '&docType=BAL_CR_ADMIN').subscribe((res: any) => {
      console.log(res);
      this.commonService.isLoader = false;
      if (res.isSuccess) {
  ...
  onWithdrawMoneySave(): any {
    ...
    if (this.creditMoneyModal.amount < walletBalance) {
      ...
      const passingData = {
        ...
        udf2:this.getnarration(this.selectedMemberCr?.code),// this.commonService.userPram.companyName+' | '+this.commonService.userPram.rmn+' | '+this.commonService.userPram.userType+''+this.commonService.userPram.id,
        ...
        narration: this.commonService.userPram.companyName+' | '+this.commonService.userPram.userType+''+this.commonService.userPram.id//this.getnarration(this.selectedMemberCr?.code)
      };
  ...
  exportAsXLSX(): any {
    ...
    const fromDt = this.commonService.formatDate((this.fromDt ? this.fromDt : new Date()), 'yyyy-mm-dd');
    const toDt = this.commonService.formatDate((this.toDt ? this.toDt : new Date()), 'yyyy-mm-dd');
    url='distributor/getdistributorbal?memberId=' + this.coutletid + '&dimemberid=' + this.commonService.userPram.memberId + '&txnNo=' + this.txnNo + '&fromDt=' + fromDt + '&toDt=' + toDt + '&docType=BAL_CR_ADMIN'
    this.commonService.getAuth(url).subscribe((res: any) => {
      console.log(res);
      this.commonService.isLoader = false;
      if (res.isSuccess) {
