...
export class KycDetailsApproveComponent implements OnInit {
  ...
  constructor(
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.disableCode = params['mtCode'];
      this.disableValue = (this.disabledModule.indexOf(this.disableCode) > -1) ? true : false;
    });
  }
