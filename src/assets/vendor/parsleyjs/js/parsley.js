...
(function (global, factory) {
  ...
  var Form__statusMapping = { pending: null, resolved: true, Declined: false };
    ...
    onSubmitValidate: function onSubmitValidate(event) {
      ...
      if ('resolved' === promise.state() && false !== this._trigger('submit')) {
        ...
        // differ in their handling of `submit` being called from inside a submit event [#1047]
          ...
          // Declined or pending: cancel this submit
  ...
  var parsley_field__statusMapping = { pending: null, resolved: true, Declined: false };
  ...
  Field.prototype = {
    ...
    whenValid: function whenValid() {
      ...
      $.each(groupedConstraints, function (_, constraints) {
        ...
        if (promise.state() === 'Declined') return false; // Interrupt processing if a group has already failed
      });
      return Utils.all(promises);
    },
  ...
  Parsley.addValidator('remote', {
    ...
    validateString: function validateString(value, url, options, instance) {
      ...
      var handleXhr = function handleXhr() {
        ...
        if (!result) // Map falsy results to Declined promise
